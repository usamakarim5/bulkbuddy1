  ...
  return (
    <>
      <div className="col-md-12 sections">
        <div className="col-md-2 px-2 pt-2 section_appliances">
          <span className="section_head">Top Deals on TV & Appliances</span>
          <button className="btn btn-primary view_all_btn" onClick={()=>{navigate('/home/top-offers', {state:AppliancesData}, {replace: true})}}>View all</button>
        </div>
